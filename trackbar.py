...
cv2.createTrackbar('huemax', 'TrackBars', 9, 179, empty)
cv2.createTrackbar('satmin', 'TrackBars', 37, 255, empty)
cv2.createTrackbar('satmax', 'TrackBars', 255, 255, empty)
cv2.createTrackbar('valmin', 'TrackBars', 49, 255, empty)
...
while True:
    ...
    image_stack = stackImages(([image, image_HSV], [mask, image_result]),0.6)
